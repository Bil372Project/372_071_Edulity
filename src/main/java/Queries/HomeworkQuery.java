...
public class HomeworkQuery {
    ...
    public List makeQuery(String hwNumber, Time dueDate, String teacherEmployeeId, String schoolName, long classSection) {
        ...
        if (hwNumber != null) {
            predicates.add(criteriaBuilder.like(root.get("hwNumber"), hwNumber));
        }
        if (dueDate != null) {
